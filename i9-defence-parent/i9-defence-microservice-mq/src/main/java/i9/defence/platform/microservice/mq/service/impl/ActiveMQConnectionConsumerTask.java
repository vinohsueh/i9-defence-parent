 ...
 * 
 */
public class ActiveMQConnectionConsumerTask extends ActiveMQConsumerTask {

    private static final Logger logger = LoggerFactory.getLogger(ActiveMQConnectionConsumerTask.class);

    private final TextMessage textMessage;

    public ActiveMQConnectionConsumerTask(TextMessage textMessage) {
