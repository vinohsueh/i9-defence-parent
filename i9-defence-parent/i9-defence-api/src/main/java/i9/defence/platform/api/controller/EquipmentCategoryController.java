...
public class EquipmentCategoryController {
	...
	public HashMap<String, Object> pageEqCategory(@RequestBody EqCategorySearchDto eqCategorySearchDto) {
	...
	/**
	    ...
	    */
	    ...
	    public HashMap<String, Object> addEqCategory(@RequestBody EquipmentCategory eqCategory) {
	        HashMap<String, Object> result = new HashMap<String, Object>();
	    ...
	    public HashMap<String, Object> getEqCategory(@RequestBody Integer EqCategoryId) {
	        HashMap<String, Object> result = new HashMap<String, Object>();
