...
cd $M_PATH
mvn -U clean compile package install -DskipTests -Pdev
...
rm -rf /tmp/i9-defence-microservice-sms.war
...
cp -R $M_PATH/i9-defence-microservice-sms/target/i9-defence-microservice-sms.war /tmp/i9-defence-microservice-sms.war
