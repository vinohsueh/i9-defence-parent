...
public class EquipmentFaultDaoImpl implements EquipmentFaultDao{
	...
	@Override
	public List<EquipmentFault> selectAllFaults() throws Exception {
		EquipmentFaultExample equipmentFaultExample = new EquipmentFaultExample();
		return equipmentFaultMapper.selectByExample(equipmentFaultExample);
	}
}
