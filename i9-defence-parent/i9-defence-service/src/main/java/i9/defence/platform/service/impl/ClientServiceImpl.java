...
public class ClientServiceImpl implements ClientService{
	...
	@Override
	public List<Client> selectClientsByIds(List<Integer> ids) throws BusinessException {
		try{
            return clientDao.selectClientsByIds(ids);
        }catch (Exception e) {
            throw new BusinessException("根据Ids查询所有客户失败",e.getMessage());
        }
	}
}
