...
public class SqlUtil {
    ...
    static {
        ...
        tablesql.append(
                " `record1` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '记录1',");
        tablesql.append(
                " `record2` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '记录2',");
        tablesql.append(
                " `record3` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '记录3',");
        tablesql.append(
                " `record_usr_log` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标记',");
    ...
    public static StringBuffer getInsertDeviceSql() {
        ...
        stringBuffer.append(
                "(`device_code`, `time_history`, `create_time`, `record1`, `record2`, `record3`) values(?,?,?,?,?,?)");
        return stringBuffer;
    }
}
