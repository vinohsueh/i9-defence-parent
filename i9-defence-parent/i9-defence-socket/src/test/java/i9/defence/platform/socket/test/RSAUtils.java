...
public class RSAUtils {
    ...
    public static String privateDecrypt(String data, RSAPrivateKey privateKey) {
        try {
            ...
            return new String(rsaSplitCodec(cipher, Cipher.DECRYPT_MODE, Base64.decodeBase64(data), privateKey
    ...
    public static String publicDecrypt(String data, RSAPublicKey publicKey) {
        try {
            ...
            return new String(rsaSplitCodec(cipher, Cipher.DECRYPT_MODE, Base64.decodeBase64(data), publicKey
                    .getModulus().bitLength()), CHARSET);
        } catch (Exception e) {
            throw new RuntimeException("解密字符串[" + data + "]时遇到异常", e);
        }
